...
<head>
    ...
    <style>
        ...
        .model-fetch-row input[type="text"],
        .model-fetch-row input[type="number"],
        .model-fetch-row select {
            padding: 10px 12px;
            border: 2px solid var(--border);
            border-radius: var(--radius-lg);
            font-size: 14px;
        ...
        .model-fetch-row input[type="text"] { flex: 1 1 320px; min-width: 200px; }
        .model-fetch-row select { flex: 0 0 150px; }
        .model-fetch-row input[type="number"] { flex: 0 0 110px; }
        .manual-model-row {
            display: flex;
            gap: 8px;
            margin-top: 10px;
        ...
        .manual-model-row input { flex: 1 1 320px; min-width: 200px; }
        .manual-model-row select { flex: 0 0 140px; }
        ...
        <main class="main">
            ...
            <div id="dropZone" class="drop-zone">
                ...
                <div class="controls-row">
                    ...
                    <button class="advanced-toggle-btn" type="button" onclick="toggleAdvancedParams()" data-i18n="advanced_params_json">高级参数 JSON</button>
                    ...
                    <div class="video-options-row" id="videoOptionsRow" style="display:none;">
                        <input type="number" id="videoDuration" class="video-mini" min="1" max="60" placeholder="时长(s)" data-i18n="video_duration_placeholder">
                        <input type="number" id="videoFps" class="video-mini" min="1" max="60" placeholder="FPS" data-i18n="video_fps_placeholder">
                        <input type="number" id="videoFrames" class="video-mini" min="9" max="801" placeholder="帧数" data-i18n="video_frames_placeholder">
                        <input type="text" id="videoSize" class="video-mini" placeholder="尺寸 768x512" data-i18n="video_size_placeholder">
                    </div>
                    <div class="advanced-params-row" id="advancedParamsRow">
                        <textarea id="advancedParamsInput" placeholder='可选：传给供应商的 JSON（例如 {"seed":123,"guidance_scale":7.5}）' data-i18n="advanced_params_placeholder"></textarea>
                    </div>
                ...
                <div id="providerEditPanel" style="display: none;">
                    ...
                    <div class="model-selector">
                        ...
                        <div class="model-toolbar">
                            ...
                            <button type="button" class="select-all-btn" onclick="keepOnlyImageModels()" data-i18n="keep_only_image_models">仅保留图像模型</button>
                        </div>
                        <div class="model-fetch-row">
                            <input type="text" id="modelFetchKeyword" placeholder="按关键词获取（如: flux, qwen, sdxl）" data-i18n="model_fetch_keyword_placeholder" autocomplete="off">
                            <select id="modelFetchType">
                                <option value="" data-i18n="model_fetch_type_all">全部类型</option>
                                <option value="chat" data-i18n="model_fetch_type_chat">对话</option>
                                <option value="image" data-i18n="model_fetch_type_image">图像生成</option>
                                <option value="vision" data-i18n="model_fetch_type_vision">图像理解</option>
                                <option value="video" data-i18n="model_fetch_type_video">视频生成</option>
                                <option value="ocr" data-i18n="model_fetch_type_ocr">OCR</option>
                                <option value="translation" data-i18n="model_fetch_type_translation">翻译</option>
                                <option value="embedding" data-i18n="model_fetch_type_embedding">向量</option>
                            </select>
                            <input type="number" id="modelFetchLimit" min="1" max="1000" value="200" placeholder="返回数量上限" data-i18n="model_fetch_limit_placeholder" title="返回数量上限">
                        </div>
                        <div class="manual-model-row">
                            <input type="text" id="manualModelId" placeholder="手动添加模型ID（如：Tongyi-MAI/Z-Image）" data-i18n="manual_model_id_placeholder" autocomplete="off">
                            <select id="manualModelType">
                                <option value="image" data-i18n="model_fetch_type_image">图像生成</option>
                                <option value="chat" data-i18n="model_fetch_type_chat">对话</option>
                                <option value="vision" data-i18n="model_fetch_type_vision">图像理解</option>
                                <option value="video" data-i18n="model_fetch_type_video">视频生成</option>
                            ...
                            <button type="button" class="fetch-models-btn" onclick="addManualModelToSelection()" data-i18n="add_model">添加模型</button>
                        </div>
                        <div class="model-search-bar">
                            <input type="text" id="modelSearchInput" placeholder="🔍 搜索模型名称..." data-i18n="model_search_placeholder" oninput="filterModelCheckboxes(this.value)" autocomplete="off">
