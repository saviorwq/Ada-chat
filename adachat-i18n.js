...
const ADA_CHAT_I18N = {
    zh: {
        ...
        preset_content: "内容",
        preset_route_models: "预设绑定模型",
        preset_route_models_hint: "每个分类可绑定一个默认模型；留空则使用全局/自动选择。",
        save_preset: "保存预设",
        new_preset: "新建预设",
        total_timeout: "总超时（秒）",
        ...
        intent_route_default_models: "自动路由默认模型",
        intent_route_default_models_hint: "可留空，留空时会使用当前供应商下该分类第一个可用模型。",
    ...
    en: {
        ...
        preset_route_models: "Preset-bound Models",
        preset_route_models_hint: "Bind a default model per category. Leave empty to use global/automatic selection.",
        ...
        intent_route_default_models: "Auto-route Default Models",
        intent_route_default_models_hint: "Can be empty. If empty, the first available model in current provider/category is used.",
